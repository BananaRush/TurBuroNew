  ...
  $(document).ready(function () {
    ...
    var bouData = {
      ...
      datasets: [{
        label: 'Мужской',
        fill: 'start',
        data: [500, 800, 320, 180, 240, 320, 230, 650, 590, 1200, 750, 940, 1420, 1200, 960, 1450, 1820, 2800, 2102, 1920, 3920, 3202, 3140, 2800, 3200, 3200, 3400, 2910, 3100, 8250],
    ...
    var ubdData = {
      datasets: [{
        ...
        data: [34.3, 24.2, 7.5, 1.5, 15.5, 20],
        backgroundColor: [
          'rgba(0,123,255,0.9)',
          'rgba(0,123,255,0.5)',
          'rgba(0,123,255,0.3)',
